...
=== TEST 1: ECDH-ES+A192KW + A256GCM ok
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
            local jwt = require "resty.jwt-verification"
            local token = "eyJhbGciOiJFQ0RILUVTK0ExOTJLVyIsImVuYyI6IkEyNTZHQ00iLCJlcGsiOnsieCI6IkFnYzRKMXQyNUJyb3JHZGl2V3hpX3NQMEN5RzkzeUxTRjVkUFVqbUtJUnciLCJjcnYiOiJYMjU1MTkiLCJrdHkiOiJPS1AifX0._l8OXP_o4JspFBYAhsr7sVqoXIx5rS-WFb0LrwOpwDbt7x6zqjlWpw.t2fmV1fvn-2gIpb_._bP7UPALArXAUXnfSw.fV5DdHttP2QvcHfoBr3J6g"
...
=== TEST 2: ECDH-ES+A192KW + A256GCM error, wrong secret
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
