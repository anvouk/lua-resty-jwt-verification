...
nil
nil
failed verifying jwt: failed finding jwk: token does not have kid header and this lib does not support this case
--- error_code: 200
--- no_error_log
[error]
...
nil
nil
failed verifying jwt: failed finding jwk: failed fetching jwks, returned unexpected http status: 404
--- error_code: 200
--- no_error_log
[error]
...
nil
nil
failed verifying jwt: failed finding jwk: invalid jwks format decoded: Expected value but found T_END at character 1
--- error_code: 200
--- no_error_log
[error]
...
nil
nil
failed verifying jwt: failed finding jwk: jwks invalid format: missing or invalid field 'keys'
--- error_code: 200
--- no_error_log
[error]
...
nil
nil
failed verifying jwt: failed finding jwk: could not find jwk with kid: D0nJOwdHZbY9GxWrCBRbgSVV
--- error_code: 200
--- no_error_log
[error]
...
=== TEST 14: error, jwk usage is for 'enc' only
--- http_config eval: $::HttpConfig
--- config
    location = /.well-known/jwks.json {
        return 200 '{"keys":[{"kid":"D0nJOwdHZbY9GxWrCBRbgSVV","use":"enc","kty":"RSA","alg":"RS256","e":"AQAB","n":"pWVkzHTMLnvbZHWFd3mVc4wlQy_I-vjnlO7If-NTlIynkP4TQnqOd50Thoq5FLMspoIH4und47zeKAhbYEYL-M37L4d25vTZsYr80Zs1DomZvXPjUkffJV8PccYw6DaTTyCuYMW9qfuDDCu9OQZxHy70KtepmkX3TebSvYigTq-XS_HcROD7tED5zeJfEmF0wHwR5B7ggbbMZj5uwbggi3rTnpEsh4Twqp_tDxtvIXc2DU2MZIWz-K8iWa4xgZ30b8hb0xCCtqTaOVkzB-VL9-NPmc74koSI6qK24eJgT4YR-xOWsgvZPaLv47qlMWWCS1ZP47fYd0UJ3ERjGjpUVQ"},{"kid":"3kC2w6oj81UbD2XKMr7hmJcl","use":"sig","kty":"RSA","alg":"RS256","e":"AQAB","n":"xZsmF55ztSgllN-B26Yt1tLn9ROXHV3x68iLjcdDdr4s0HT_qJ7GexM8FGqmiZCs4EbKXkkVA-0cvSklXWUJxIA-HWP2vXnv_fHp-YD9OCdhuzOprp5wKd3ukGBfwa7xAA_vLlGrMh0FdHMJxzuesg4-IxO8QiFrDnA8AMdvCptLcm9GQRDuEBJDmJ0PBc-vhv4cJ5UsBlY50MrMhHlbWR6koCFkjVFY9MGsujARi8uVXJBSkZBm3p5Msl5gdxd2659vjn-pUgkTN0gPzz0omYWcpJVBFF_JxknGu87UBn4LKci02ZEBCSpxXKnPn60iH8Qx6RpSA5UiTCb--reQuQ"}]}';
    }
...
nil
nil
failed verifying jwt: matching jwk with kid 'D0nJOwdHZbY9GxWrCBRbgSVV' cannot be used for signing
--- error_code: 200
--- no_error_log
[error]

=== TEST 15: error, jwt is a jwe
--- http_config eval: $::HttpConfig
--- config
    location = /.well-known/jwks.json {
        return 200 '{"keys":[{"kid":"D0nJOwdHZbY9GxWrCBRbgSVV","use":"sig","kty":"RSA","alg":"RS256","e":"AQAB","n":"pWVkzHTMLnvbZHWFd3mVc4wlQy_I-vjnlO7If-NTlIynkP4TQnqOd50Thoq5FLMspoIH4und47zeKAhbYEYL-M37L4d25vTZsYr80Zs1DomZvXPjUkffJV8PccYw6DaTTyCuYMW9qfuDDCu9OQZxHy70KtepmkX3TebSvYigTq-XS_HcROD7tED5zeJfEmF0wHwR5B7ggbbMZj5uwbggi3rTnpEsh4Twqp_tDxtvIXc2DU2MZIWz-K8iWa4xgZ30b8hb0xCCtqTaOVkzB-VL9-NPmc74koSI6qK24eJgT4YR-xOWsgvZPaLv47qlMWWCS1ZP47fYd0UJ3ERjGjpUVQ"},{"kid":"3kC2w6oj81UbD2XKMr7hmJcl","use":"sig","kty":"RSA","alg":"RS256","e":"AQAB","n":"xZsmF55ztSgllN-B26Yt1tLn9ROXHV3x68iLjcdDdr4s0HT_qJ7GexM8FGqmiZCs4EbKXkkVA-0cvSklXWUJxIA-HWP2vXnv_fHp-YD9OCdhuzOprp5wKd3ukGBfwa7xAA_vLlGrMh0FdHMJxzuesg4-IxO8QiFrDnA8AMdvCptLcm9GQRDuEBJDmJ0PBc-vhv4cJ5UsBlY50MrMhHlbWR6koCFkjVFY9MGsujARi8uVXJBSkZBm3p5Msl5gdxd2659vjn-pUgkTN0gPzz0omYWcpJVBFF_JxknGu87UBn4LKci02ZEBCSpxXKnPn60iH8Qx6RpSA5UiTCb--reQuQ"}]}';
    ...
    location = /t {
        content_by_lua_block {
            ...
            local decoded_token, err = jwks.verify_jwt_with_jwks(
                "eyJhbGciOiJkaXIiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2IiwiY3JpdCI6WyJhbGciLCJqa3UiXSwiamt1IjoiQUFBIn0..OrZ9URPkUuiaOkPUJYotdQ.1emn8ciejd7IDtB_pNRbu97j9kBmi6GsztYW-6KYOXw.Wf_-dIehI-Gb6CiUPyI72w",
                "http://127.0.0.1:1984/.well-known/jwks.json",
                nil
            )
            ngx.say(decoded_token)
...
nil
nil
failed verifying jwt: parsed token is a jwe
--- error_code: 200
--- no_error_log
[error]
